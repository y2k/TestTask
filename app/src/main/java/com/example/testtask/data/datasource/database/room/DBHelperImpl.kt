...
class DBHelperImpl @Inject constructor(
    ...
    override fun writeEmployeesToDB(employeeList: ArrayList<EmployeeDB>) {
    ...
    override fun writeSpecialitiesToDB(specialityList: ArrayList<SpecialtyDB>) {
        specialityDao.insertSpecialityList(specialityList)
    }

    override fun readEmployeesFromDB(): List<EmployeeDB> {
